...
export function About() {
  return (
    <section id="about" className="border-t-2 border-[#1b3a6b]/15 bg-cream px-5 py-20 md:px-12 md:py-32">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-14 grid grid-cols-1 gap-10 md:mb-24 md:gap-16 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center gap-6">
            <p className="text-base leading-relaxed text-[#080808]/65">
            ...
            <p className="font-mono text-xs leading-relaxed text-[#1b3a6b]/40">
              Skills developed: equity research · financial modeling · algorithmic strategy · consulting · valuation analysis
            </p>
          </div>
        </div>

        <div className="grid grid-cols-1 border border-[#1b3a6b]/20 md:grid-cols-2">
          <StatCounter value={3} suffix="" label="Core Departments" />
          <div className="border-t border-[#1b3a6b]/20 md:border-l md:border-t-0">
