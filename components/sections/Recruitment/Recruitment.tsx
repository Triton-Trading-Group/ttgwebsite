...
export function Recruitment() {
  return (
    <section id="recruitment" className="border-t border-[#1b3a6b]/15 bg-cream px-5 py-20 md:px-12 md:py-32">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-10 border-t border-[#1b3a6b]/15 md:mb-16" />
        ...
        <div className="grid grid-cols-1 items-start gap-10 md:gap-16 lg:grid-cols-2">
          <div>
            ...
            <p className="mb-10 max-w-md text-base leading-relaxed text-[#080808]/65">
            ...
            <div className="mb-10 space-y-3">
              {[
                ...
                <div key={i} className="flex items-start gap-3 text-sm text-[#080808]/65">
                  <span className="mt-1 shrink-0 font-mono text-xs text-[#1b3a6b]/60">0{i + 1}</span>
                  <span>{step}</span>
                </div>
              ))}
            </div>

            <ApplyNowLink className="inline-block w-full border border-[#1b3a6b] px-10 py-4 text-center font-mono text-sm tracking-widest uppercase text-[#1b3a6b] transition-all duration-200 hover:bg-[#1b3a6b] hover:text-white sm:w-auto">
              Apply Next Quarter
            </ApplyNowLink>
          </div>

          <div className="relative">
            <div className="relative overflow-hidden border border-[#1b3a6b]/15">
              <Image
            ...
            <div className="absolute right-3 bottom-3 left-3 grid grid-cols-1 gap-2 sm:grid-cols-2">
              {[
                ...
                <div key={i} className="border border-[#1b3a6b]/20 bg-cream/90 p-3 backdrop-blur-sm">
                  <span className="block font-mono text-xs text-[#1b3a6b]/50">{stat.label}</span>
